...
use App\Http\Middleware\OAuth\CustomGuard;
use App\Http\Middleware\OAuth\SetPassportGuard;
...
Route::group([
    ...
    'middleware' => [SetPassportGuard::class,]
], function () {
    $guard = session('passport.guard', 'student');
